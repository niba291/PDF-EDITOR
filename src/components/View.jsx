    ...
    return(
        <div className="float-end -mt-[0.185rem]" ref={ref}>
            <button type="button" className="border px-2 py-1 rounded text-sm hover:bg-gray-100 w-40 mr-1 text-red-500" onClick={() => {
                ...
                path.pop();
                let value       = jp.query(state, path.join(".")).filter((item, index) => {
                    return index !== path[path.length - 1]
                });
                path.pop();
                jp.value(state, path.join("."), value);
                setState({...state});
...
export function JsonRecursive({object, jsonKey, state, setState}) {   
    ...
    if(typeof(object) === "string"){
        return(
            <article className="w-full flex flex-wrap border border-t-0 rounded-b py-2 px-4">
                <span className="w-2/6 px-2">
                    value
                </span>
                <input className="w-4/6 px-2 border rounded" value={object} onInput={(e) => {
                    jp.value(state, `$${jsonKey}.children`, e.target.value);
                    setState({...state});
                }}/>
            </article>
        );
                        ...
                        {type !== "TEXT" ? 
                            <details className="w-full">
                                ...
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-2">
                                    ...
                                    <div className="w-4/6">
                                        <button className={`border px-1 py-1 rounded text-sm hover:bg-gray-100 mr-1 ${props.style.flexDirection === "row" ? "bg-gray-100" : ""}`}>
                                        ...
                                        <button className={`border px-1 py-1 rounded text-sm hover:bg-gray-100 mr-1 ${props.style.flexDirection === "col" ? "bg-gray-100" : ""}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
                                ...
                                <div className="border px-2 py-1 flex flex-wrap rounded justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">aling items</h1>
                                    <div className="w-4/6">
                                        <button className={`border px-1 py-1 rounded text-sm hover:bg-gray-100 mr-1 ${props.style.alignItems === "start" ? "bg-gray-100" : ""}`}>
                                        ...
                                        <button className={`border px-1 py-1 rounded text-sm hover:bg-gray-100 mr-1 ${props.style.alignItems === "center" ? "bg-gray-100" : ""}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
                                        ...
                                        <button className={`border px-1 py-1 rounded text-sm hover:bg-gray-100 mr-1 ${props.style.alignItems === "end" ? "bg-gray-100" : ""}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
                                ...
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">width</h1>
                                    <input type="text" className="w-4/6 border px-2 rounded" defaultValue={props.style.width}/>
                                </div>
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">height</h1>
                                    <input type="text" className="w-4/6 border px-2 rounded" defaultValue={props.style.height}/>
                                </div>
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">background color</h1>
                                    <input type="color" className="w-4/6 border px-2 rounded" defaultValue={props.style.height}/>
                                </div>
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                ...
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">border radius</h1>
                                    <input type="text" className="w-4/6 border px-2 rounded" defaultValue={props.style.borderRadius}/>
                                </div>
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">padding</h1>
                                    <input type="text" className="w-4/6 border px-2 rounded" defaultValue={props.style.padding}/>
                                </div>
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">margin</h1>
                                    <input type="text" className="w-4/6 border px-2 rounded" defaultValue={props.style.margin}/>
                                </div>
                            </details>
                            :
                            <details className="w-full">
                                ...
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-2">
                                    ...
                                    <div className="w-4/6">
                                        <button className={`border px-1 py-1 rounded text-sm hover:bg-gray-100 mr-1 ${props.style.textAlign === "left" ? "bg-gray-100" : ""}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
                                        ...
                                        <button className={`border px-1 py-1 rounded text-sm hover:bg-gray-100 mr-1 ${props.style.textAlign === "center" ? "bg-gray-100" : ""}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
                                        ...
                                        <button className={`border px-1 py-1 rounded text-sm hover:bg-gray-100 mr-1 ${props.style.textAlign === "right" ? "bg-gray-100" : ""}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
                                ...
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">text decoration</h1>
                                    <input type="text" className="w-4/6 border px-2 rounded" defaultValue={props.style.textDecoration}/>
                                </div>
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">font weight</h1>
                                    <input type="text" className="w-4/6 border px-2 rounded" defaultValue={props.style.fontWeight}/>
                                </div>
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">font weight</h1>
                                    <input type="text" className="w-4/6 border px-2 rounded" defaultValue={props.style.fontSize}/>
                                </div>
                                <div className="border px-2 py-1 rounded flex flex-wrap justify-center mr-1 items-center w-full mt-1">
                                    <h1 className="w-2/6 py-1">width</h1>
                                    <input type="text" className="w-4/6 border px-2 rounded" defaultValue={props.style.width}/>
